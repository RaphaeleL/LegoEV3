...
public class Main {
	...
	private static UltrasonicSensor ur = new UltrasonicSensor(SensorPort.S3);
	private static IRSeeker is = new IRSeeker(SensorPort.S4);
	private static Move move = new Move(MotorPort.A, MotorPort.D);
	private static Shot shot = new Shot(MotorPort.B, SensorPort.S2);
