...
class HotRod():
    ...
    def setBeep(self, pitch, time, volume): 
        self.brick.sound.beep(pitch, time, volume)

    def setSound(self, soundfile): 
        self.brick.sound.file(soundfile)
    ...
    def forward(self): 
        self.engine.run(self.speed_of_engine)

    def moveLeft(self): 
        self.wheels.run_time(self.speed_of_wheels, self.time_of_wheels)

    def moveRight(self): 
        self.wheels.run_time(-1 * self.speed_of_wheels, self.time_of_wheels)
